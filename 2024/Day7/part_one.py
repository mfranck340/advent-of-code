...
def evaluate_expression(numbers, operators):
    """Evalúa una expresión de izquierda a derecha dada una lista de números y operadores."""
    result = numbers[0]
...
# Calcular la suma total de los valores válidos
result = find_valid_equations(input_text)
print(f"Resultado total: {result}")
